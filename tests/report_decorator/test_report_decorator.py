...
def test_decorar_relatorio():
    simple_colored = ColoredReport(SimpleReport).generate(mock)
    fabricacao = "\033[36m2020-09-06\033[0m"
    validade = "\033[36m2023-09-17\033[0m"
    empresa = "\033[31mTarget Corporation\033[0m"
    assert simple_colored == (
        f"\033[32mData de fabricação mais antiga:\033[0m {fabricacao}\n"
        f"\033[32mData de validade mais próxima:\033[0m {validade}\n"
